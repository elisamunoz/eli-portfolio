...
const Page = () => (
  ...
  >
    <Article
      paragraph=' Birdsongs of the World is a website dedicated to sharing bird sounds from all over the world. Whether you are a research scientist, a birder, or simply curious about a sound you heard out the window, we invite you to listen, download, and explore the bird sound recordings in the collection.
      <br />
      It connects to a third party API to obtain birdsong and geolocate some of the information using Google Maps.
      <br />
      This website has been possible thanks to the'
    ><Link href="https://www.xeno-canto.org/article/153">Xeno-Canto Api</Link>.
